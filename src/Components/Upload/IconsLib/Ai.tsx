...
function SvgAi(props: SVGProps<SVGSVGElement>) {
  return (
    <svg className="icon file-icon file-icon--ai" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.607 24" {...props}>
      ...
      <path className="file-icon__type" d="M9.416 15.795H7.584l-.3.66h-.716l1.572-3.504h.72l1.571 3.504h-.72l-.295-.66zM8.5 13.688l-.651 1.491H9.15l-.65-1.491zM10.729 16.455v-3.504h.655v3.504h-.655z" />
    </svg>
  );
}
